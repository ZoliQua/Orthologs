# This file reads the eggNOG db to parse it to the 7 species
...
eggnog_source_filename = "data/eggnog/eggnog5/2759_members.tsv"
export_filename = "data/eggnog/eggnog5db_7_species_by_groups.tsv"
export_filename_species = "data/eggnog/eggnog5db_{}_protein_list.tsv"
...
with open(eggnog_source_filename, newline='') as f:
...
for i in eggnog_taxlist:
    ...
    filename_individual = export_filename_species.format(i)
    print(filename_individual)

    with open(filename_individual, mode='w') as export_file:
